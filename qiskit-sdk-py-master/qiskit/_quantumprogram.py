...
class QuantumProgram(object):
    ...
    def run(self, qobj, wait=5, timeout=600):
    ...
    def run_batch(self, qobj_list, wait=5, timeout=1200):
    ...
    def run_async(self, qobj, wait=5, timeout=600, callback=None):
    ...
    def run_batch_async(self, qobj_list, wait=5, timeout=1200, callback=None):
    ...
    def _run_internal(self, qobj_list, wait=5, timeout=600, callback=None,
    ...
    def execute(self, name_of_circuits, backend="local_qasm_simulator",
                config=None, wait=5, timeout=600, basis_gates=None,
